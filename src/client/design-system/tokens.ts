export const DARK = {
  ...
  piece: { face: "#dbb068", promoted: "#C41E3A", promotedGlow: "rgba(196,30,58,0.4)", border: "#5a3d1c", text: "#3A2A10" },
...
export const LIGHT = {
  ...
  piece: { face: "#dbb068", promoted: "#B8162E", promotedGlow: "rgba(184,22,46,0.25)", border: "#5a3d1c", text: "#3A2A10" },
